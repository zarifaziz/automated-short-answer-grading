...
- See [training_model.ipynb](./notebooks/training_model.ipynb) for details.
- See [grading_model.py](./src/asag/grading_model.py) for the final LLM pipeline structure
- See [extracted_prompt.txt](./data/extracted_prompt.txt) for the optimised prompt that is used
